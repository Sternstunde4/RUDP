...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, ShuffleOrderTest, DupTest, SackRandomDropTest, \
        SackShuffleOrderTest, SackDupTest
    #filename = "README"
    filename = "run.mp4"
    ...
    # 失序到达
    ShuffleOrderTest.ShuffleOrderTest(forwarder, filename)
    SackShuffleOrderTest.SackShuffleOrderTest(forwarder, filename)
    # 重复到达
    DupTest.DupTest(forwarder, filename)
    SackDupTest.SackDupTest(forwarder, filename)
